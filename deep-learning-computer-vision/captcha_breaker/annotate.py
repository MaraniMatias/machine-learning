"""
python3 annotate.py --input downloads --annot dataset
"""
...
ap.add_argument(
    "-a", "--annot", required=True, help="path to output directory of annotations"
)
...
for (i, imagePath) in enumerate(imagePaths):
    ...
    try:
        ...
        for c in cnts:
            ...
            cv2.imshow("ROI", imutils.resize(roi, width=64))
            key = cv2.waitKey(0)
